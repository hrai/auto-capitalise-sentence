...
!(function (t, e) {
  ...
  class xt extends R {
    constructor(t, e) {
      super(t, e),
        ...
        (this._menu =
          Y.next(this._element, Tt)[0] ||
          Y.prev(this._element, Tt)[0] ||
          Y.findOne(Tt, this._parent)),
    ...
    static dataApiKeydownHandler(t) {
      ...
      const n = this.matches(Et)
          ...
          : Y.prev(this, Et)[0] ||
            Y.next(this, Et)[0] ||
            Y.findOne(Et, t.delegateTarget.parentNode),
        o = xt.getOrCreateInstance(n);
      if (s) return t.stopPropagation(), o.show(), void o._selectMenuItem(t);
      o._isShown() && (t.stopPropagation(), o.hide(), n.focus());
    }
  }
  j.on(document, wt, Et, xt.dataApiKeydownHandler),
    ...
    j.on(document, yt, Et, function (t) {
  ...
  class Ne extends R {
    ...
    dispose() {
      clearTimeout(this._timeout),
        j.off(this._element.closest(Te), ke, this._hideModalHandler),
  ...
  class Ge extends R {
    ...
    _keydown(t) {
      ...
      i && (i.focus({ preventScroll: !0 }), Ge.getOrCreateInstance(i).show());
    }
    _getChildren() {
